...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230308114129_Changed Stock TimeSeries Relationship")]
    partial class ChangedStockTimeSeriesRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.TimeSeries", b =>
                {
                    ...
                    b.HasIndex("StockSymbol")
                        .IsUnique()
                        .HasFilter("[StockSymbol] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.TimeSeries", b =>
                {
                    b.HasOne("Domain.Entities.Stock", "Stock")
                        .WithOne("TimeSeries")
                        .HasForeignKey("Domain.Entities.TimeSeries", "StockSymbol")
                        .HasPrincipalKey("Domain.Entities.Stock", "Symbol");
